...
?>
        <section class="page-section" id="main">
            <div class="container">
                <div class="row">
                    <div class="col-lg12">
                        <h1>Our Privacy Policy & Notice</h1>
                        <p><strong>1. INTRODUCTION</strong></p>
                        <p>This privacy notice provides you with details of how we collect and process your personal data through your use of our site DallasMatthews.com</p>
                        <p>By providing us with your data, you warrant to us that you are over 13 years of age.</p>
                        <p>Al Elliott of Oblong Media is the data controller and he is responsible for your personal data (referred to as “we”, “us” or “our” in this privacy notice).</p>
                        <p><strong>Contact Details</strong></p>
                        <p>Our full details are: Al Elliott, Unit 85, 792 Wilmslow Road, MANCHESTER, M20 6UG.</p>
                        <p>Full name of legal entity: Oblong Media</p>
                        <p>Email address: help@oblongHQ.com</p> 
                        <p>Postal address: Oblong Media, Unit 85, 792 Wilmslow Road, MANCHESTER, M20 6UG.</p>
                        <p>It is very important that the information we hold about you is accurate and up to date. Please let us know if at any time your personal information changes by emailing us at help@oblongHQ.com. </p>
                        ...
                        <p>We will only use your personal data for a purpose it was collected for or a reasonably compatible purpose if necessary. For more information on this please email us at help@oblongHQ.com.  In case we need to use your details for an unrelated new purpose we will let you know and explain the legal grounds for processing.</p>
                        ...
                        <p>We may also receive data from publicly available sources such as Companies House and the Electoral Register based inside the EU.</p>
                        ...
                        <li>Other brands or websites we use for marketing purposes</li>
                        ...
                        <p>You can see more about these rights at:https://ico.org.uk/for-organisations/guide-to-the-general-data-protection-regulation-gdpr/individual-rights/</p>
                        <p>If you wish to exercise any of the rights set out above, please email us at help@oblongHQ.com. You will not have to pay a fee to access your personal data (or to exercise any of the other rights). However, we may charge a reasonable fee if your request is clearly unfounded, repetitive or excessive or refuse to comply with your request in these circumstances.</p>
                        ...
                        <p>You can set your browser to refuse all or some browser cookies, or to alert you when websites set or access cookies. If you disable or refuse cookies, please note that some parts of this website may become inaccessible or not function properly. For more information about the cookies we use, please see https://oblong.digital/cookies".</p>
                        <p><strong>12. 3rd Party Policies</strong></p>
                        <ul>
                        <li>Mailchimp: https://midweekwines.co.uk/mailchimp-data-processing-agreement/</li>
                        <li>Active Campaign: https://www.activecampaign.com/privacy-policy/</li>
                        <li>WordPress: Please contact me if you would like to remove the data that WordPress stores on you</li>
                        <li>Facebook: https://www.facebook.com/business/gdpr</li>
                        <li>Google: https://privacy.google.com/businesses/processorterms/</li>
                        <li>LinkedIn: https://www.linkedin.com/legal/sas-terms</li>
                        <li>Hotjar: https://www.hotjar.com/privacy</li>
                        </ul>
                    </div>
                </div>
